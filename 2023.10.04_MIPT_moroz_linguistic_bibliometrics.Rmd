...
```{r, include=FALSE}
database <- read_csv("/home/agricolamz/work/bureaucracy/linguistic_convergency/journals/umap/2023-10-01.csv")
```
...
Разметка "лингвистичесноти" журналов -- огромная и слабо автоматизируемая работа, которая требует экспертизы в самых разных областях лингвистики.
...
>- библиографическое описание книги (в случаях ревью)
